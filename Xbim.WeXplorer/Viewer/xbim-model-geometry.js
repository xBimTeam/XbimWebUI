    ...
    (function (Viewer) {
        var ModelGeometry = (function () {
            ...
            ModelGeometry.prototype.parse = function (binReader) {
                ...
                var iTransform = 0;
                var iMatrix = 0;
                var stateEnum = Xbim.Viewer.State;
                var typeEnum = Xbim.Viewer.ProductType;
                ...
                for (var iShape = 0; iShape < numShapes; iShape++) {
                    ...
                    //read shape geometry
                    var shapeGeom = new Viewer.TriangulatedShape();
                    shapeGeom.parse(br);
            ...
            ModelGeometry.prototype.load = function (source) {
                //binary reading
                var br = new Viewer.BinaryReader();
                var self = this;
            ...
            ModelGeometry.prototype.onloaded = function () { };
            ModelGeometry.prototype.onerror = function (message) { };
            return ModelGeometry;
        }());
        Viewer.ModelGeometry = ModelGeometry;
    })(Viewer = Xbim.Viewer || (Xbim.Viewer = {}));
})(Xbim || (Xbim = {}));
//# sourceMappingURL=xbim-model-geometry.js.map
        ...
        var Viewer = (function () {
            ...
            */
            Viewer.prototype.resetStates = function (hideSpaces) {
                ...
                if (hideSpaces) {
                    this._handles.forEach(function (handle) {
                        handle.setState(Viewer_1.State.HIDDEN, Viewer_1.ProductType.IFCSPACE);
                    }, this);
                }
                this._stylingChanged = true;
            };
            ...
            */
            ...
            Viewer.prototype._initShaders = function () {
                ...
                compile(fragmentShader, Viewer_1.Shaders.fragment_shader);
                //vertex shader (the more complicated one)
                var vertexShader = gl.createShader(gl.VERTEX_SHADER);
                compile(vertexShader, Viewer_1.Shaders.vertex_shader);
                //link program

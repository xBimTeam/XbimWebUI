...
(function (Xbim) {
    ...
    (function (Viewer) {
        var BinaryReader = (function () {
            ...
            BinaryReader.prototype.onloaded = function () { };
            BinaryReader.prototype.onerror = function (message) { };
            ...
            BinaryReader.prototype.getIsEOF = function (type, count) {
                if (typeof (this._position) === "undefined")
                    throw "Position is not defined";
                return this._position == this._buffer.byteLength;
            };
            BinaryReader.prototype.read = function (arity, count, ctor) {
            ...
            BinaryReader.prototype.readByte = function (count) {
                return this.read(1, count, Uint8Array);
            };
            BinaryReader.prototype.readUint8 = function (count) {
                return this.read(1, count, Uint8Array);
            };
            BinaryReader.prototype.readInt16 = function (count) {
                return this.read(2, count, Int16Array);
            };
            BinaryReader.prototype.readUint16 = function (count) {
                return this.read(2, count, Uint16Array);
            };
            BinaryReader.prototype.readInt32 = function (count) {
                return this.read(4, count, Int32Array);
            };
            BinaryReader.prototype.readUint32 = function (count) {
                return this.read(4, count, Uint32Array);
            };
            BinaryReader.prototype.readFloat32 = function (count) {
                return this.read(4, count, Float32Array);
            };
            BinaryReader.prototype.readFloat64 = function (count) {
        ...
        Viewer.BinaryReader = BinaryReader;
    })(Viewer = Xbim.Viewer || (Xbim.Viewer = {}));
})(Xbim || (Xbim = {}));
//# sourceMappingURL=xbim-binary-reader.js.map
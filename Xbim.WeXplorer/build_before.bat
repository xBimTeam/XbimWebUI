...
Utilities\spacker.exe Viewer shaders.ts -typescript -min -variable:Xbim.Viewer.Shaders   && ^
Utilities\spacker.exe Plugins\NavigationCube navigation-cube-shaders.ts -typescript -min -variable:CubeShaders 

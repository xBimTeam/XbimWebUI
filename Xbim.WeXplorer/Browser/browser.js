...
var xBrowser = (function () {
    ...
    */
    function xBrowser(lang, culture) {
        ...
        this._model = new visual_model_1.xVisualModel(null);
        this._events = [];
        this._templates = {};
        this._lang = lang;
        ...
        this._templates = {};
        //compile templates
        var templateStrings = visual_templates_1.xVisualTemplates();
        ...
        if (source instanceof Blob || source instanceof File) {
            ...
            fReader.onloadend = function () {
                if (fReader.result) {
                    ...
                    var utils = uk ? new cobieuk_utils_1.xCobieUkUtils(self._lang, self._culture) : new cobie_utils_1.xCobieUtils(self._lang, self._culture);
